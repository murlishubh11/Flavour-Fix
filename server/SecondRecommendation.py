...
class Recommender:
    ...
    def k_neighbor(self, inputs, feature_df, dataframe, k):
        ...
        for i in list(indices):
            df_results = pd.concat([df_results, dataframe.loc[i]])
...
profiles = pd.read_csv(r'C:\Users\NAVUDU NARAYANA RAO\Desktop\newproject\private\server\csvfile\user_Profiles.csv')
recent_activity = pd.read_csv(r'C:\Users\NAVUDU NARAYANA RAO\Desktop\newproject\private\server\csvfile\recent_activity.csv')
dataset = pd.read_csv(r'C:\Users\NAVUDU NARAYANA RAO\Desktop\newproject\private\server\dataset.csv')
